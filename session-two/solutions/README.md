# Solutions — don't open until told

> **Don't open the rest of this folder until the lab walkthrough tells
...
If you've already finished the synthesis exercise (or you're picking
this up after the lab), this folder is your reference. Compare your
own themes against `themes.md` to see what you found that we missed,
and what we found that you missed — both are interesting.
